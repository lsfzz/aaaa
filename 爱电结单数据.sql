...
SELECT * FROM dbo.WOMDAF  WITH (NOLOCK) WHERE DAF016>='2022-11-01' AND DAF014='5103'
...
ON BFD001=BFC001 AND BFD002=BFC002 AND BFD003=BFC003 AND BFD004=BFC004
 JOIN dbo.INVBFE  WITH (NOLOCK) ON BFE001=BFC001 AND BFE002=BFC002 AND BFE003=BFC003 AND BFE004=BFC004
 WHERE BFC001='DGAE' AND BFC002='8502' AND BFC005='5104' AND BFC006='20220800544' AND LEFT(BFD006,2)>=30 AND BFC003='5604'  --半成品不良退料也属报废，按单品算
 UNION ALL
  SELECT BFC001  AS BAB001,BFC002 AS BAB002,BFC005 AS	BAB003,BFC006 AS BAB004,BFE005 AS BAB005,BFC005+'-'+BFC006+'-'+BFC002 AS BAB006,BFD006 AS BAB007,
BFD007 AS BAB008,BFD008 AS BAB009,'Y'AS 	BAB010,BFD006 AS	BAB011,BFD007 AS	BAB012,BFD008 AS	BAB013,BFD011 AS BAB014,BFE011 AS BAB015,BFD009 AS BAB016,
BFC017 AS	BAB017,BFC015+' '+BFC016 AS	BAB018,'Y'	BAB019  FROM dbo.INVBFC  WITH (NOLOCK) JOIN dbo.INVBFD  WITH (NOLOCK)
ON BFD001=BFC001 AND BFD002=BFC002 AND BFD003=BFC003 AND BFD004=BFC004
 JOIN dbo.INVBFE  WITH (NOLOCK) ON BFE001=BFC001 AND BFE002=BFC002 AND BFE003=BFC003 AND BFE004=BFC004
 WHERE BFC001='DGAE' AND BFC002='8502' AND  BFC005='5104' AND BFC006='20220800544'AND BFC003='5608'    ---报废
...
SELECT * FROM dbo.INVLAA  WITH (NOLOCK) WHERE SyncKey='04851751022021040032169'
 ...
 SELECT BFC001  AS BAB001,BFC002 AS BAB002,BFC005 AS	BAB003,BFC006 AS BAB004,BFE005 AS BAB005,BFC005+'-'+BFC006+'-'+BFC002 AS BAB006,BFD006 AS BAB007,
                                                        ...
                                                        ON BFD001=BFC001 AND BFD002=BFC002 AND BFD003=BFC003 AND BFD004=BFC004
                                                        JOIN dbo.INVBFE  WITH (NOLOCK) ON BFE001=BFC001 AND BFE002=BFC002 AND BFE003=BFC003 AND BFE004=BFC004
                                                        WHERE BFC001='DGAE' AND BFC002='8502' AND BFC005='5104'  AND LEFT(BFD006,2)>=30 AND BFC003='5604'  --半成品不良退料也属报废，按单品算
                                                        UNION ALL
                                                        SELECT BFC001  AS BAB001,BFC002 AS BAB002,BFC005 AS	BAB003,BFC006 AS BAB004,BFE005 AS BAB005,BFC005+'-'+BFC006+'-'+BFC002 AS BAB006,BFD006 AS BAB007,
                                                        BFD007 AS BAB008,BFD008 AS BAB009,'Y'AS 	BAB010,BFD006 AS	BAB011,BFD007 AS	BAB012,BFD008 AS	BAB013,BFD011 AS BAB014,BFE011 AS BAB015,BFD009 AS BAB016,
                                                        BFC017 AS	BAB017,BFC015+' '+BFC016 AS	BAB018,'Y'	BAB019  FROM dbo.INVBFC  WITH (NOLOCK) JOIN dbo.INVBFD  WITH (NOLOCK)
                                                        ON BFD001=BFC001 AND BFD002=BFC002 AND BFD003=BFC003 AND BFD004=BFC004
                                                        JOIN dbo.INVBFE  WITH (NOLOCK) ON BFE001=BFC001 AND BFE002=BFC002 AND BFE003=BFC003 AND BFE004=BFC004
                                                        WHERE BFC001='DGAE' AND BFC002='8502' AND  BFC005='5104' AND BFC006='20221200053'AND BFC003='5608'    ---报废
...
'' as DAB003,'' as DAB004,
'' as DAB005,A.INIT_RQTY as DAB006,  ---条码数量
'' AS DAB007, ---批次号
B.MTRL_NAME AS DAB008, ---规格型号
''   AS DAB009, ---状态
TO_CHAR(A.SYS_CRT_DATE, 'yyyy-MM-dd') AS DAB010, ---到厂日期
'' AS DAB011, ---LOTNO
B.MTRL_DESC AS DAB012, ---客户品番
A.INIT_RQTY  as DAB013,--入库数量
'' as DAB014,   '' as DAB015,
'' as DAB016,  '' as DAB017,
'' as DAB018,A.SUP_ID as DAB019,
B.ERP_MTRL_ID as DAB020,B.MTRL_DESC as DAB021,
'' as DAB022, '' as DAB023,
'' AS DAB024, -- 0 免检 、1是待检、2 已检 、
'' as DAB025,'' as DAB026,
'' as DAB027, '引用IMS半成品条码' as DAB028,
'0' as DAB029, A.CUST_ID as DAB030,
'Y' as DAB031,'1' as DAB032,  --1、在库，2、备料，3、接收，4、投产  ，5、退料 (因为是ERP直接抽取)
